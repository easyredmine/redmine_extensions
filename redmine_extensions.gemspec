...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency 'capybara', '~> 3.3.1'
  spec.add_development_dependency 'selenium-webdriver', '3.12.0'
  spec.add_development_dependency 'factory_bot_rails', '~> 4.6'
